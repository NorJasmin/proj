...
namespace proj.Controllers
{
    public class MothersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Email,Contact,Address,Occupation,Salary,Namec,Mykid")] Mother mother)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Email,Contact,Address,Occupation,Salary,Namec,Mykid")] Mother mother)
        {
            if (ModelState.IsValid)
            {
