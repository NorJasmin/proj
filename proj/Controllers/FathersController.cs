...
namespace proj.Controllers
{
    public class FathersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Email,Contact,Address,Occupation,Salary,Namec,Mykid")] Father father)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Email,Contact,Address,Occupation,Salary,Namec,Mykid")] Father father)
        {
            if (ModelState.IsValid)
            {
